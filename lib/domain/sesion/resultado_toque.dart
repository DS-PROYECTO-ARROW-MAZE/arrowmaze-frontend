...
class ResultadoToque {
  const ResultadoToque._(this.tipo, this.trayectoria);
  ...
  /// The whole [trayectoria] exited the board.
  ResultadoToque.valido(Trayectoria trayectoria)
      : this._(TipoToque.valido, trayectoria);
