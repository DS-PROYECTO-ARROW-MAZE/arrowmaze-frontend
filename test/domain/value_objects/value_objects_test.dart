...
void main() {
  group('Vector3', () {
    test('should_add_componentwise_and_negate', () {
      // Arrange
  ...
  group('Posicion', () {
    test('should_step_to_the_neighbour_along_a_direction', () {
      // Arrange
  ...
  group('Direccion', () {
    test('should_expose_the_opposite_of_each_cardinal', () {
      // Arrange / Act / Assert
      expect(Direccion.arriba.opuesta, Direccion.abajo);
      expect(Direccion.izquierda.opuesta, Direccion.derecha);
    });

    test('should_compare_by_value_and_list_four_cardinals', () {
      // Arrange / Act / Assert
